...
namespace FragrantFlowers
{
    class MallowAromaCanConfig : IEntityConfig
    {
        ...
        public GameObject CreatePrefab()
        {
            ...
            AromaticsFabricator.RegisterAromaticsRecipe(new ComplexRecipe.RecipeElement[1] { new ComplexRecipe.RecipeElement(ID, 1f) }, MallowScent.ID, STRINGS.GERMS.MALLOWSCENT.DESCRIPTION);
